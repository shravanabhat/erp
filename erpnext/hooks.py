...
website_route_rules = [{'from_route': '/frontend/<path:app_path>', 'to_route': 'frontend'}, {'from_route': '/frontendd/<path:app_path>', 'to_route': 'frontendd'}, {'from_route': '/frontend/<path:app_path>', 'to_route': 'frontend'}, {'from_route': '/uiacc/<path:app_path>', 'to_route': 'uiacc'},]