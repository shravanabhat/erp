...
<<<<<<< HEAD
@frappe.whitelist()
def get_child_table_data(docname):
    try:
        # Fetch data from the child table
        data = frappe.get_all('Journal Entry Account', filters={'parent': docname},
                              fields=['*'])  # Add other fields as needed
        return data
    except Exception as e:
        frappe.msgprint(f"Error fetching child table data: {str(e)}")
        return None
=======
